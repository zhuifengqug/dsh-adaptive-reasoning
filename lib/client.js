  ...
  factory: (require) => {
    ...
    if (typeof document !== 'undefined' && document.querySelector(`style[data-plugin-css="${STYLE_ID}"]`) === null) {
      ...
      style.textContent = `
        ...
        .dar-track { position: relative; display: grid; align-items: end; height: 32px; border: 2px solid #2e2926; border-radius: 0; background: #070606; box-shadow: inset 0 0 0 2px #070606; image-rendering: pixelated; }
