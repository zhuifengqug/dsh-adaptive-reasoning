  ...
  factory: (require) => {
    ...
    if (typeof document !== 'undefined' && document.querySelector(`style[data-plugin-css="${STYLE_ID}"]`) === null) {
      ...
      style.textContent = `
        ...
        .dar-cell { flex: 1; min-width: 4px; background: #282420; border: 1px solid #3a352f; }
        .dar-cell-on { background: #9e2410; border-color: #d8502a; box-shadow: inset 0 0 3px rgba(255, 122, 66, 0.55); }
...
void main(){
  ...
  vec3 ember = vec3(0.34, 0.31, 0.29);
  vec3 wmid  = vec3(0.58, 0.06, 0.03);
  vec3 wht   = vec3(1.0, 0.16, 0.10);
  float temp = 1.0 - dn;
