  ...
  factory: (require) => {
    ...
    if (typeof document !== 'undefined' && document.querySelector(`style[data-plugin-css="${STYLE_ID}"]`) === null) {
      ...
      style.textContent = `
        ...
        .dar-track { position: relative; display: grid; align-items: end; height: 32px; overflow: hidden; border: 1px solid var(--dsw-alias-border-l2); border-radius: 8px; background: rgba(16, 6, 5, 0.62); }
        ...
        .dar-fill { position: absolute; bottom: 4px; left: 0; height: 3px; border-radius: 999px; background: #a11d0c; pointer-events: none; opacity: 0.75; transition: width 140ms ease; }
